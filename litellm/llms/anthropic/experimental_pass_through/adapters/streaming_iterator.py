...
class AnthropicStreamWrapper(AdapterCompletionStreamWrapper):
    ...
    def _merge_usage_into_held_stop_reason_chunk(self, chunk: Any) -> Dict[str, Any]:
        ...
        # Anthropic-native backends set the private ``_cache_read_input_tokens``;
        # OpenAI-shaped backends (e.g. GitHub Copilot) only populate
        # ``prompt_tokens_details.cached_tokens``. Prefer the former, fall back to
        # the latter, mirroring ``translate_openai_response_to_anthropic``.
